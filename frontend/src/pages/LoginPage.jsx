  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-void px-4 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-1/2 -left-1/2 h-full w-full animate-[aurora-pulse_8s_ease-in-out_infinite] rounded-full bg-aurora/5 blur-[120px]" />
        <div className="absolute -bottom-1/2 -right-1/2 h-full w-full animate-[aurora-pulse_8s_ease-in-out_infinite_2s] rounded-full bg-violet/5 blur-[120px]" />
        <div className="absolute top-1/4 left-1/4 h-96 w-96 animate-[aurora-pulse_10s_ease-in-out_infinite_1s] rounded-full bg-cyan/3 blur-[100px]" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md animate-fade-in-up">
        ...
        <div className="mb-10 text-center">
          ...
          <p className="mt-2 text-sm text-ghost">Welcome back. Pick up where you left off.</p>
        </div>
        ...
        <p className="mt-6 text-center text-sm text-ghost animate-fade-in-up delay-5">
          New here?{' '}
          <Link to="/register" className="font-semibold text-aurora-light transition-colors duration-200 hover:text-aurora">
            Create an account
          </Link>
        </p>
      </div>
